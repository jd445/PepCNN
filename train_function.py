...
def trainning(n_epochs, patience, batch_size, data_path):
    ...
    model = PepCNN(gap_constraint=5, item_size=length_itemset).to(device)
    ...
    for epoch in tqdm(range(n_epochs)):
        ...
        for batch in train_loader:
            ...
            loss = mixup_criterion(criterion, outputs, targets_a.long(),
                                   targets_b.long(), lam)
...
if __name__ == '__main__':
    trainning(n_epochs=4500, patience=4500, batch_size=4 *
